...
export const PRODUCTS = [
  ...
  { id: 7, sku: 'BP-004', name: 'Papan Grand Opening', price: 950000, disc: 5, city: 'Surabaya', cat: 'Papan', sold: 88, date: '2024-03-23', img: 'https://images.unsplash.com/photo-1519378018457-3ce2a73abc2a?w=600&h=600&fit=crop', desc: 'Bunga papan megah untuk memeriahkan pembukaan usaha baru.' },
  ...
  { id: 11, sku: 'HB-004', name: 'Sun Flower Bouquet', price: 250000, disc: 15, city: 'Surabaya', cat: 'Bouquet', sold: 450, date: '2024-03-27', img: 'https://images.unsplash.com/photo-1470509037663-25d97a2255e2?w=600&h=600&fit=crop', desc: 'Buket bunga matahari ceria untuk menyemangati hari orang tersayang.' },
  { id: 12, sku: 'ST-003', name: 'Standing Flower Premium', price: 1500000, disc: 10, city: 'Jakarta', cat: 'Standing', sold: 40, date: '2024-03-28', img: 'https://images.unsplash.com/photo-1516706562550-244bb0cb6fe5?w=600&h=600&fit=crop', desc: 'Standing flower khusus dengan bunga-bunga import pilihan.' },
  { id: 13, sku: 'BP-006', name: 'Papan Selamat Ulang Tahun', price: 550000, disc: 0, city: 'Bandung', cat: 'Papan', sold: 125, date: '2024-03-29', img: 'https://images.unsplash.com/photo-1525310238806-38472506cc13?w=600&h=600&fit=crop', desc: 'Bunga papan meriah untuk perayaan ulang tahun rekan atau keluarga.' },
  { id: 14, sku: 'HB-005', name: 'Orchid Flower Box', price: 650000, disc: 5, city: 'Medan', cat: 'Bouquet', sold: 95, date: '2024-03-30', img: 'https://images.unsplash.com/photo-1453904300235-0f2f60b15b3d?w=600&h=600&fit=crop', desc: 'Rangkaian anggrek dalam box eksklusif yang tahan lama.' },
  { id: 15, sku: 'ST-004', name: 'Standing Flower Colorful', price: 900000, disc: 10, city: 'Jakarta', cat: 'Standing', sold: 75, date: '2024-03-31', img: 'https://images.unsplash.com/photo-1523694559144-42b07e0b1900?w=600&h=600&fit=crop', desc: 'Standing flower dengan nuansa warna-warni yang ceria.' },
];
